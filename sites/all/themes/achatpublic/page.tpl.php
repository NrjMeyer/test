...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language ?>" lang="<?php print $language->language ?>" dir="<?php print $language->dir ?>">
	<head>
		...
		<?php if($_COOKIE['read_documentation'] != "1"): ?>
			<script type="text/javascript" src="<?php echo base_path().path_to_theme() ?>/javascript/script_documentation.js"></script>
		<?php endif; ?>
		<!--[if lt IE 7]>
...
<!-- Layout -->
		...
		<div id="documentation_form" class="hide">
			<div class="contenu_generic overlay">
				<h1 class="actualite"><img src="<?php echo base_path().path_to_theme() ?>/images/point_actualites.png" alt="" title="" /> Accès aux documentations</h1>
